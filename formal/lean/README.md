...
is `VZEROUPPER; RET`. [`X86Noninterference.lean`](NaryaFormal/X86Noninterference.lean)
connects the definite-assignment certificate to the machine semantics and
