...
def generate() -> str:
    ...
    lines.extend(
        [
            "def foldBroadcastPhase : List Instruction := foldPhase.take 1",
            "def foldArithmeticPhase : List Instruction := foldPhase.drop 1",
            "def normalizeBroadcastPhase : List Instruction := normalizePhase.take 1",
            "def normalizeArithmeticPhase : List Instruction := normalizePhase.drop 1",
            "",
            "def arithmeticCorePhase : List Instruction :=",
            "  productPhase ++ combinePhase ++ foldPhase ++ normalizePhase",
            "",
            "set_option maxRecDepth 4096 in",
            "theorem constant_phase_splits :",
            "    foldPhase = foldBroadcastPhase ++ foldArithmeticPhase ∧",
            "    normalizePhase = normalizeBroadcastPhase ++ normalizeArithmeticPhase ∧",
            "    foldBroadcastPhase.length = 1 ∧ foldArithmeticPhase.length = 10 ∧",
            "    normalizeBroadcastPhase.length = 1 ∧ normalizeArithmeticPhase.length = 15 := by",
            "  decide",
            "",
            "theorem arithmetic_core_length : arithmeticCorePhase.length = 94 := by",
            "  decide",
            "",
